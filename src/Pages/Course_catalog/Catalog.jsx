...
import threeD from "../../Assets/3D_design.jpg"
      ...
      <section className="main-sect">
        ...
        <div className="main-container">
          ...
          <div className="courses">
            ...
            <Course search={backEnd} title="Back-end kursi" subtitle="Bu kursda siz dasturlashning Back-end qismini asoslariga o'rganasiz." price={900}/>
            <Course search={motion} title="Motion dizayn kursi" subtitle="Bu kursda siz motion dizaynning asoslariga o'rganmisiz." price={500}/>
            <Course search={threeD} title="3D dizayn kursi" subtitle="Bu kursda siz blenderda kubni o'chirishga o'rganasiz." price={500}/>
            <Course search={UIUX} title="UIUX dizayn kursi" subtitle="Bu kursda siz saytlarning dizaynini qilishga o'rganib bizni hakaton guruhimizda dizayner bo'lasiz." price={300}/>
            <Course search={tester} title="Tester kursi" subtitle="Bu kursda siz saytlarni xatolarga tekshirishni o'rganasiz." price={400}/>
            <Course search={chess} title="Shaxmat kursi" subtitle="Bu kursda siz shaxmat yosh razrad 2ga ko'tarasiz." price={100}/>
          </div>
        </div>
      </section>
    </main>
