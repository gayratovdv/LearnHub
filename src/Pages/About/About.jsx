        ...
        <div className="main-content">
          ...
          <div className="section2">
            ...
            <div className="mySlides fade">
              <img src="../../Assets/images/image2.png" style={{ width: "100%" }} alt="Slide 1" />
            </div>
            <div className="mySlides fade">
              <img src="../../Assets/images/image1.png" style={{ width: "100%" }} alt="Slide 2" />
            </div>

            <div className="mySlides fade">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQAsUy5b__XFZjxQwP0pixPal4-DvSSViZAMrgakOGJWfWCXcIDOuu_MF_fhRsfb-XNY7U&usqp=CAU" style={{ width: "100%" }} alt="Slide 3" />
            </div>
